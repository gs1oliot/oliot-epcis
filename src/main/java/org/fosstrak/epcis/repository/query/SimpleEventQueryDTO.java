...
public class SimpleEventQueryDTO {
    ...
    private boolean hasMatchEpc = false;
    private boolean hasGE_Eventtime = false;
    private boolean hasLT_Eventtime = false;
    private boolean hasParentID = false;
    //ParentID of AggregationEvent, meaning FridgeID
    ...
    public boolean hasMatchEpc() {
        return hasMatchEpc;
    }

    public void setHasMatchEpc(boolean hasMatchEpc) {
        this.hasMatchEpc = hasMatchEpc;
    }
    
    public boolean hasGE_Eventtime() {
        return hasGE_Eventtime;
    }

    public void setHasGE_Eventtime(boolean hasGE_Eventtime) {
        this.hasGE_Eventtime = hasGE_Eventtime;
    }

    public boolean hasLT_Eventtime() {
        return hasLT_Eventtime;
    }

    public void setHasLT_Eventtime(boolean hasLT_Eventtime) {
        this.hasLT_Eventtime = hasLT_Eventtime;
    }
